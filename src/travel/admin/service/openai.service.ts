...
export class OpenAIService {
  ...
  async parseTourAnnouncementFromInstagram(
    ...
    try {
      ...
      - duration: string (e.g., "5 days", "1 week", "3 nights") (optional)
      - start_date: string in YYYY-MM-DD format, year cannot be in the past, default year is current year (optional), if not mentioned then return null
      ...
      3. For dates, use YYYY-MM-DD format, year cannot be in the past, default year is current year.
